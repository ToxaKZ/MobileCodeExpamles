...
public class FavoritesActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        try {
            ...
            ExceptionHelper.getInstance().alertException(FavoritesActivity.this, e);
        }
    ...
    private void clear() {
        new AlertDialog.Builder(this)
                .setMessage(getString(R.string.question_clear_favorites))
                .setCancelable(true)
    ...
    private final class FavoritesAdapter extends RecyclerView.Adapter<ViewHolder> {
        private ArrayList<FavoriteModel> mDataset = null;

        public FavoritesAdapter() {
            try {
                mDataset = DatabaseHelper.getInstance(FavoritesActivity.this).getFavorites();
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            final FavoriteModel item = mDataset.get(position);
            ...
            holder.mDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        DatabaseHelper.getInstance(FavoritesActivity.this).setFavorites(mDataset);
                        refresh();
                    } catch (Exception e) {
                        ExceptionHelper.getInstance().alertException(FavoritesActivity.this, e);
                    }
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ArticleActivity.show(FavoritesActivity.this, item.getDirectionId(),
